 ...
 *  @brief Create socket, read socket and write socket. 
 *
 ...
 *
 *  @param none
 *  @return On success, return sockfd (socket descriptor). On error, return -1.
 */
 ...
 *
 *  Read data from socket. Data can be commands, console log request, console log clear request.
 *
 *  @param sockfd (Socket descriptor)
 *  @return On success, return request (request from DUT). On error, return NULL.
 */
 ...
 *  Other than console logs request, success or failure has to be sent.
 *
 *  @param console_logs (console logs or errors or infomration) and sockfd (socket descriptor)
 *  @return On success, return retVal (0 on success, -1 on failure).
 */
